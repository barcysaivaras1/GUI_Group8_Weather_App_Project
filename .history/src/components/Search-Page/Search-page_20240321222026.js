...
function NewWeatherSearchPage() {
    ...
    const [selected_city,setSelectedCity] = useState("") //creating a useCase to capture it's value
    ...
    const weatherData = useNewWeatherData(selectedOption === 'country' ? cityArray : searchTermsArray); // Fetches weatherData from different arrays based on selection
